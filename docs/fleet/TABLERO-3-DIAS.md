...
| Max-2 | [ ] `docs/planes/PLAN-M15.md` con sello de vigencia → visto bueno de Mauricio → **P-M15-01** (migraciones) y **P-M15-02** (Dispatcher + canales) | L | Opus 4.8 · high | Plan aprobado; migraciones y servicios con tests en la rama |
| Director | [ ] Constituirse (leer kickoff + docs), validar PLAN-M15, abrir ledger día 1, dictar modelo/esfuerzo a cada cuenta | M | Sonnet 5 · high | Tablero y ledger al día; dictados entregados a Mauricio |
