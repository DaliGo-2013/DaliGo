...
- **El «Hecho cuando» de E6 — ✅ ENMENDADO** (autorización del dueño, 2026-07-30). Decía «hasta el **reingreso a stock**», que no se puede cumplir: con el kardex local se satisface en términos **locales**, pero no hay escritura real en Bsale y no la habrá hasta M04/D-005. Quedó redactado «…hasta el **CIERRE de la devolución** —reembolso aprobado vía M14 **o** movimiento de reingreso registrado en el kardex local—», con nota de enmienda fechada en `docs/RUTA-MAESTRA.md` §E6. En el mismo movimiento se corrigieron las **dos líneas adyacentes que la misma decisión falsificaba**: las dependencias (decían `E4, E5-F1`, o sea que E6 estaba bloqueada por dos módulos que no existen) y el texto de P-M13-03 («movimiento M04»).
