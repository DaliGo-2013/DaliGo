...
| Campo | Valor |
|---|---|
| **Última actualización** | 2026-07-06 (**P-M12-01 piloto [EN CURSO]** — ingreso a ST por QR sin login + correo al confirmar + historial compartido con separación por sucursal de recepción, en rama `feature/m12-ingreso-qr-piloto`; falta QA staging + merge por el gate) · 2026-07-02 (P-SPK-01/02 hechos: PWA instalable + cola offline; P-S0-18: recetario + skills `/arranque` `/cierre` `/pre-merge`) |
