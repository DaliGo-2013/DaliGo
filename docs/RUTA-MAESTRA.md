...
- [ ] **P-NAV-06** · (post-visto bueno del dueño) Pantallas huérfanas al menú: Máquinas/Tipos de botellón/Kardex bajo Operación, Conductores bajo ST — 4 líneas de datos en `MenuPrincipal` + regenerar bundle de diseño (`DesignCaptureTest` → DesignSync) para que claude.ai/design refleje la app real
