...
| **Próximo paso** | **P-M16V1-05**: gate `/pre-merge` R-31 + merge doble llave de `feature/m16-accesos-iconos` (E10-v1.2) · Stream 1: **STANDBY** (dictado v23 — espera a que el dueño dimensione #6 chips paramétricos con el Director, o los hallazgos del QA de borde P-TZ-03 de esta noche) · Stream 2: DESPACHOS-V1 (P-DSP-04+) · Mauricio: P-TZ-03 (~21:30) + `P-S0-03/04` briefs |
...
- [ ] **P-M16V1-05** · Gate pre-merge R-31 (`/pre-merge`) + merge coordinado con doble llave a main
