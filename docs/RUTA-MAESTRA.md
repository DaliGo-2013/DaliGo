...
- [ ] **P-M12-02** [EN CURSO — fase CORREO hecha 2026-07-21, rama `feature/st-cotizacion-correo`] · Cotización estructurada del técnico + aprobación del cliente por link. **Hecho:** snapshot `orden_servicio_cotizaciones` + carta formal por correo + página pública firmada ACEPTO/NO ACEPTO (sin comentario, decisión del dueño) + avisos M15 a tecnico/jefe_ventas/vendedor/admin (720 verdes; bitácora 2026-07-21). **Falta:** botón `wa.me` con el mismo link (hasta D-007)
