...
| **Unidad activa** | **E1 · M15 Notificaciones** [stream 2, MERGEADO a main, falta QA staging] · **E2 · M14 Aprobaciones** [stream 1, EN CONSTRUCCIÓN — plan aprobado, P-M14-01 hecho en rama `feature/m14-aprobaciones`] · E0 cerrada salvo pendientes menores (P-S0-03/04/05/06 + P-S0-09/10/11/12) |
| **Próximo paso** | Stream 1: **P-M14-03** (bandeja móvil `/aprobaciones`) — P-M14-01/02 hechos en rama `feature/m14-aprobaciones` (`5d9286d`+`5470f31`, 461 tests; ANTES de seguir el 08-07: `/model` Opus 4.8 + vigilancia crontab reportada al Director) · Stream 2: QA-FUNCIONAL-STAGING de M15 vía IA-cPanel (veredicto APROBADO cierra P-M15-09) → P-M15-10 SPF/DKIM · Mauricio: `P-S0-03/04` briefs |
