...
- [ ] **P-PAR-DASH-2** · Cortes de antigüedad del taller configurables (7/30 → claves con validación cruzada reciente < antiguo) + desacople del `$d7` bicéfalo (la «última semana» queda fija con variable propia y porqué nivel 3); rótulos «0-7 · 8-30 · 30+» y «llevan 30+ días» derivados
