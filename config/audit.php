...
return [
    ...
    */
    ...
    |
    | En produccion se mantiene false: los seeders del deploy (CLI) NO deben
    | generar audits. En tests (phpunit, que corre como CLI) se activa via
    | AUDITING_CONSOLE=true en phpunit.xml para que los audits se registren.
    |
    */
