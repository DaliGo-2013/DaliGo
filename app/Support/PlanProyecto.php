...
class PlanProyecto
{
    ...
    public const MODULOS = [
        ...
        'M04' => ['fase' => 'F2', 'label' => 'M04 Inventario', 'inicio' => '2026-09-01', 'fin' => '2026-10-15',
            'hecho' => ['Espejo de bodegas y stock desde Bsale (sync horaria)', 'Clasificación local editable: bodega↔sucursal, propósito, operación (D-003 pre-cargada, F1)', 'Wizard de baja con orden de traslado y cierre automático post-sync (F2)'],
            'falta' => ['Kardex unificado (F3)', 'Reservas por vendedor', 'Transferencias entre bodegas']],
        ...
        'M11' => ['fase' => 'F2', 'label' => 'M11 Producción', 'inicio' => '2026-06-20', 'fin' => '2026-12-05',
            'hecho' => ['Ciclo completo: asignar → tandas del soplador → enviar → aprobar', 'Kardex local al aprobar (consumo de preforma + producción + merma)', 'Descuento de preforma contra el stock real (receta paramétrica: componentes = (buenos + merma) × cantidad, con tapa)', 'Paradas del turno con duración en la PWA (7 motivos, clase planificada/no planificada)', 'OEE por máquina contra su meta + Pareto de paradas', 'Alertas SIC cada 2 h + panel «Hoy en vivo» del jefe', 'Molde como entidad: contador de ciclos automático, umbral con aviso y correctiva por «Molde dañado»', 'Cola offline del soplador (PWA, sin señal en planta)', 'Panel del jefe con drill-downs e historial'],
            'falta' => ['Meta del día', 'Gráficos de productividad (GP)', 'Semáforo de preformas + notas del jefe (P-M11-22, en curso)', 'Kaizen digital (F3)']],
        ...
        'M18' => ['fase' => 'F2', 'label' => 'M18 Logística', 'inicio' => '2026-08-04', 'fin' => '2026-08-31',
            'hecho' => ['Flota de vehículos: ficha, documentos y asignación (reemplaza la planilla «Control vehiculos»)', 'Semáforo automático de vencimientos (revisión técnica, emisiones, permiso de circulación, SOAP, extintor)', 'Aviso por la app '.\App\Models\Vehiculo::DIAS_AVISO.' días antes de vencer y el día que vence (franja configurable)', 'Estado del vehículo separado del conductor: dar de baja exige decir por qué', 'Los 17 vehículos de la flota cargados en producción', 'Catálogo de conductores dentro de Logística (venía de Servicio Técnico)', 'Descarga de la flota en Excel, al día y con el semáforo calculado', 'Simulador de carga con visor 3D: cupo máximo por producto y CARGA MIXTA («¿cabe esta carga?») con acomodo por zonas'],
            'falta' => ['QA del dueño', 'Calibrar el simulador contando una carga real', 'Kilometraje y mantenciones (fuera de alcance por decisión del dueño 04-08)']],
