...
class PlanProyecto
{
    ...
    public const MODULOS = [
        ...
        'M04' => ['fase' => 'F2', 'label' => 'M04 Inventario', 'inicio' => '2026-09-01', 'fin' => '2026-10-15',
            'hecho' => ['Espejo de bodegas y stock desde Bsale (sync horaria)', 'Clasificación local editable: bodega↔sucursal, propósito, operación (D-003 pre-cargada, F1)'],
            'falta' => ['Wizard de baja con orden de traslado (F2)', 'Kardex unificado (F3)', 'Reservas por vendedor', 'Transferencias entre bodegas']],
