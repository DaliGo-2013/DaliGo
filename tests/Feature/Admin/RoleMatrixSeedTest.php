...
class RoleMatrixSeedTest extends TestCase
{
    ...
    private function matrix(): array
    {
        return [
            ...
            'jefe_bodega' => ['view users', 'manage production', 'view servicio tecnico', 'ver todo servicio tecnico', 'confirmar servicio tecnico', 'aprobar solicitudes', 'manage despachos', 'ver informe dispensadores', 'ver informe industrial', 'recibir traslado servicio', 'autorizar carga'],
            ...
            // sin tocar código.
            'jefe_logistica' => ['ver vehiculos', 'manage vehiculos', 'manage hojas ruta'],
