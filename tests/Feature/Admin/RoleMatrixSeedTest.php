    ...
    private function matrix(): array
    {
        return [
            'admin' => [
                ...
                'agendar servicio terreno', 'ver agenda terreno', 'gestionar instalaciones',
            ...
            'jefe_ventas' => ['view users', 'manage clientes', 'view servicio tecnico', 'aprobar solicitudes', 'agendar servicio terreno', 'gestionar instalaciones', 'autorizar reparacion'],
