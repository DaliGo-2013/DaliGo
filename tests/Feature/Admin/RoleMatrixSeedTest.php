...
class RoleMatrixSeedTest extends TestCase
{
    ...
    private function matrix(): array
    {
        return [
            ...
            'jefe_sucursal' => ['view users', 'manage clientes', 'view servicio tecnico', 'ver todo servicio tecnico', 'aprobar solicitudes', 'ver informe dispensadores', 'ver informe industrial', 'emitir nota de credito', 'despachar traslado servicio', 'usar mensajes'],
            'jefe_bodega' => ['view users', 'manage production', 'view servicio tecnico', 'ver todo servicio tecnico', 'confirmar servicio tecnico', 'aprobar solicitudes', 'manage despachos', 'ver informe dispensadores', 'ver informe industrial', 'recibir traslado servicio', 'manage devoluciones', 'simular carga', 'autorizar carga', 'usar mensajes'],
            ...
            'conductor' => ['crear lote servicio', 'confirmar entrega', 'ver vehiculos', 'usar mensajes'],
            ...
            'tecnico' => ['view servicio tecnico', 'ver todo servicio tecnico', 'manage servicio tecnico', 'confirmar servicio tecnico', 'crear lote servicio', 'recibir traslado servicio', 'ver informe dispensadores', 'usar mensajes'],
            'tecnico_industrial' => ['ver agenda terreno', 'ver servicios terreno', 'gestionar instalaciones', 'ver informe industrial', 'usar mensajes'],
            'soplador' => ['report production', 'usar mensajes'],
            ...
            // sin tocar código.
            'jefe_logistica' => ['ver vehiculos', 'manage vehiculos', 'simular carga', 'manage hojas ruta', 'usar mensajes'],
            ...
            'jefe_despacho' => ['manage hojas ruta', 'autorizar ruta', 'usar mensajes'],
        ];
    }
