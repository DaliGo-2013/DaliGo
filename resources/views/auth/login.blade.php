<x-guest-layout>
    <header class="mb-6">
        <h1 class="text-xl font-semibold tracking-tight text-neutral-900">{{ __('Log in') }}</h1>
        <p class="mt-1 text-sm text-neutral-500">Ingresa a tu cuenta de DaliGo.</p>
    </header>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input id="email" class="mt-1.5" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="tu@correo.cl" />
