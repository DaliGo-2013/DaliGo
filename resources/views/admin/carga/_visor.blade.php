...
<div class="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm"
    ...
    <div class="flex items-stretch">
        ...
        <aside x-show="menu" x-cloak
               class="w-56 shrink-0 space-y-0.5 overflow-y-auto border-r border-neutral-200 bg-neutral-50/70 p-2 text-xs"
            ...
            {{-- Cuánto se ve cargado. «▶» reproduce la estiba de a poco (para mirar en
                 qué ORDEN va la carga) y los pasos permiten armarla a mano: de a uno
                 para el detalle, de a 5 o de a 10 para avanzar, «Todo» y «Vaciar» para
                 los extremos (pedido del dueño 05-08). --}}
            <p class="{{ $titulo }}">Cargar</p>
            ...
            @if (! empty($escena['pallet']))
                {{-- Armar el pallet en el piso y SUBIRLO: el visor arranca con el pallet
                     al costado y el camión vacío. --}}
