...
@php
    ...
    // En MÓVIL el `sm` sube a 44px, el mínimo táctil de Apple: con 36px los
    // iconos de Editar/Eliminar de una fila quedan pegados y se toca el
    // equivocado — y uno de ellos borra. Desde sm: vuelve la densidad de fila,
    // donde se apunta con el mouse.
