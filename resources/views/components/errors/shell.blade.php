...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .codigo-label { margin: 24px 0 0; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: .08em; color: #737373; } /* #a3a3a3 daba 2.42:1 sobre #fafafa: no pasa WCAG AA (gate R-31) */
