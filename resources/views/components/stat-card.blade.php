...
<a href="{{ $href }}"
    class="block rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm sm:p-5 transition duration-150 hover:border-neutral-300 hover:shadow active:scale-[0.98]">
